...
// Get ACF fields for this category (individual category fields)
$context['fields'] = get_field('block', 'category_' . $category->term_id);
...
<?php
Timber::render('./partials/category.twig', $context);
get_footer();